...
const circles = document.querySelectorAll(".circle").forEach((e) => e.style.background = chosenColor);
const todoBtn = document.querySelectorAll(".todo-btn").forEach((e) => e.style.background = chosenColor);
const loginBtn = document.querySelector(".login-form")
const weatherInfo = document.querySelector(".weather-info");
const brushBtn = document.querySelector(".main-footer__color-btn");
weatherInfo.style.background = chosenColor;
// todoBtn.style.background = chosenColor;
const widget = document.querySelector(".widget");
const greeting = document.querySelector(".greeting");
// const todoList = document.querySelector(".weather-city");
...
function handleColor() {
    ...
    // todoList.style.background = chosenColor;
    widget.style.background = chosenColor;
    greeting.style.color = chosenColor;
}
handleColor();
